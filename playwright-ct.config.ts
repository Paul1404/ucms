...
// exercised exactly as it runs in the browser. Assertions key off inline frame
// styles, not CSS classes, so the tests do not depend on Tailwind. Pure geometry
// (including resize snapping) stays in Vitest.
